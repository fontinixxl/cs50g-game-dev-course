            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        gStateStack:push(BattleMessageState('Congratulations! Level Up!', function() end, false))

                        Timer.after(1.5, function()
                            gStateStack:push(StatsMenuState(self.battleState, self.playerPokemon:levelUp(), 
                                function()
                                    -- pop off BattleMessageState
                                    gStateStack:pop()
                                    -- get back to the playState
                                    self:fadeOutWhite()
                                end)
                            )
                        end)
