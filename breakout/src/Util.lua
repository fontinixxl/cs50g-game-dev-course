...
function GenerateQuadsBricks(atlas)
    local mixedQuad = {}
    mixedQuad = table.slice(GenerateQuads(atlas, 32, 16), 1, 24)
    -- remove hearts quad 1,2 so we have the LockerBrick available as another color
    table.remove(mixedQuad, 22)
    table.remove(mixedQuad, 22)
...
-- last row starts at (12x12+1) 145 position
