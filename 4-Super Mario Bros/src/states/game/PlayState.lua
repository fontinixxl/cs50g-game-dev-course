...
function PlayState:enter(params)
    ...
    -- Ensure that the player isn’t placed above a column that just spawned a chasm
    -- by looking at all of the tiles along the Y-axis, going from left to right,
    -- until we’ve come across a column where we encounter a solid tile
